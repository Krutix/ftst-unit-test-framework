...
${FTST_EXE}:	${FTST_TEST_RUNNER_SRC} ${BUILD_LIB}
			@${FTST_CC} ${FTST_COMPILE_FLAGS} ${FTST_FLAGS} ${FTST_TEST_RUNNER_SRC} ${FTST_SRCS} ${FTST_TEST_SRCS} -o ${FTST_EXE} || \
			{	printf ${FTST_PRETTY_STATUS}	"${FTST_PRETTY_FAIL}" "${FTST_COMPILE_MODE}" "$<" "compile" ; exit 1;	}
